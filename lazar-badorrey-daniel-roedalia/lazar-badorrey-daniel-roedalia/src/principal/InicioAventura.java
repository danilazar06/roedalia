...
public class InicioAventura {
    ...
    public static void main(String[] args) {
        ...
        new Alquimista("Zoltar", elisabetha, lance).start();
        new Alquimista("Morkar", elisabetha, lance).start();

        new DragonCarmesi(elisabetha).start();
        ...
        System.out.println("Fueron felices y comieron perdices.");
        System.exit(0);
    }
}
